...
const App = () => {
  ...
  const addNewNumber = (event) => {
    ...
    {
      let newId = Math.floor((Math.random() * 9999999999) + 1);

      let newEntry = {name: newName, number: newPhone, id: JSON.stringify(newId)}
      console.log("New id: ", newId)
      console.log("New object: ", newEntry)

      phonebook.addEntry(newEntry).then(res => {
        setPersons(persons.concat({...newEntry, id: newId}))
      })
      .then(() => {
